...
$c_Ltutorial_webapp_TutorialApp$.prototype.setupUI__V = (function() {
  var jsx$1 = (0, $m_Lorg_querki_jquery_package$().$$$1)("<button type=\"button\">Click me!</button>").click($m_Lorg_querki_jquery_package$().f02EventHandler__F0__sjs_js_$bar(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this) {
    return (function() {
      $m_Ltutorial_webapp_TutorialApp$().addClickedMessage__V()
    })
  })(this))));
  var a = (0, $m_Lorg_querki_jquery_package$().$$$1)("body");
  jsx$1.appendTo(a);
